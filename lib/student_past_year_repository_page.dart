// lib/student_past_year_repository_page.dart
...
class StudentPastYearRepositoryPage extends StatefulWidget {
  const StudentPastYearRepositoryPage({super.key});

  @override
  State<StudentPastYearRepositoryPage> createState() =>
      _StudentPastYearRepositoryPageState();
}

class _StudentPastYearRepositoryPageState
    extends State<StudentPastYearRepositoryPage> {
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              const _StudentHeader(), // with logout
              ...
              // Load faculties ONCE (stream) so we can resolve names + filter
                      ...
                      StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                        ...
                        builder: (context, snap) {
                          ...
                          var filtered = items.where((p) {
                            final matchesFaculty = _selectedFacultyId == null ||
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        // Logout button (replaces profile image circle)
        Material(
          color: Colors.white,
          borderRadius: BorderRadius.circular(10),
          child: InkWell(
