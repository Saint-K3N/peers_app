// lib/peer_counsellor_home_page.dart
      ...
      return Row(
        children: [
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Peer Counsellor', style: textTheme.titleMedium),
          ...
          InkWell(
            ...
            onTap: () => Navigator.pushNamed(context, '/counsellor/profile'),
            child: CircleAvatar(
              radius: 18,
      ...
      builder: (context, userSnap) {
        ...
        return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, appsSnap) {
            ...
            return _GreetingCardCounsellor(
              userName: name,
              upcoming: upcoming,
              pending: pending,
...
class _GreetingCardCounsellor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snap) {
        ...
        if (docs.isEmpty) {
          return PeerCounsellorHomePage._emptyBox("No appointments for today.");
        }

        return Column(
          children: [
            for (final d in docs) ...[
              _CounsellorScheduleTile(appDoc: d),
              const SizedBox(height: 12),
            ]
          ],
        );
        ...
        try {
          ...
          if (apptData != null) {
            ...
            if (studentData != null && peerData != null) {
              ...
              final peerRole = peerData['role'] ?? 'Peer Counsellor';
