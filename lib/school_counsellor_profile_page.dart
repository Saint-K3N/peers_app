// lib/school_counsellor_profile_page.dart
...
class SchoolCounsellorProfilePage extends StatefulWidget {
  const SchoolCounsellorProfilePage({super.key});

  @override
  State<SchoolCounsellorProfilePage> createState() => _SchoolCounsellorProfilePageState();
}
...
class InterestItem {
  ...
  factory InterestItem.fromDoc(DocumentSnapshot<Map<String, dynamic>> d) {
    ...
    return InterestItem(
      ...
      seq: (data['seq'] ?? 0) is int ? data['seq'] as int : int.tryParse('${data['seq'] ?? 0}') ?? 0,
...
class _SchoolCounsellorProfilePageState extends State<SchoolCounsellorProfilePage> {
  ...
  Future<void> _pickAndUploadAvatar() async {
    ...
    try {
      ...
      final path = 'users/$_uid/avatar_${DateTime.now().millisecondsSinceEpoch}_$filename';
      ...
      body: SafeArea(
        child: _uid.isEmpty
          ...
          builder: (context, userSnap) {
            ...
            // Base fields
            final fullName = (u[kFieldFullName] ?? u['displayName'] ?? u['name'] ?? '').toString();
            ...
            final acad = <String>[
              ...((u[kFieldAcademic] is List)
                  ? (u[kFieldAcademic] as List).map((e) => e.toString()).toList()
                  : const <String>[]),
            ];
            final coun = <String>[
              ...((u[kFieldCounseling] is List)
                  ? (u[kFieldCounseling] as List).map((e) => e.toString()).toList()
                  : const <String>[]),
            ];
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  _HeaderSC(onLogout: () => _logout(context)),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('View or edit your information', style: t.bodySmall),
                          ],
                        ),
                      ),
                      SizedBox(
                        ...
                        child: FilledButton(
                          ...
                          child: Text(_editing ? (_saving ? 'Saving...' : 'Save') : 'Edit',
                  ...
                  _CardShell(
                    child: Row(
                      ...
                      children: [
                        _AvatarBlock(
                          photoUrl: photoUrl,
                          fullNameFallback: fullName.isNotEmpty ? fullName : 'SC User',
                          editing: _editing,
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(fullName.isNotEmpty ? fullName : 'Unknown Counsellor',
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  hintText: 'Add a short bio or note...',
                                  contentPadding:
...
class _HeaderSC extends StatelessWidget {
  final VoidCallback onLogout;
  const _HeaderSC({required this.onLogout});
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            stream: interestsCol.where('category', isEqualTo: category).snapshots(),
            builder: (context, snap) {
              ...
              final items = (snap.data?.docs ?? const <QueryDocumentSnapshot<Map<String, dynamic>>>[])
              ...
              return Wrap(
                ...
                children: items.map((it) {
                  ...
                  return FilterChip(
                    label: Text(it.title, style: const TextStyle(fontWeight: FontWeight.w700)),
                    selected: sel,
